...
import { Tv, Users, BarChart3, Shield, Zap, Globe, Target, TrendingUp, Database, ArrowRight } from "lucide-react"
      ...
      <div className="relative z-10">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            <Badge className="mb-6 bg-slate-800/50 text-cyan-400 border-cyan-500/50">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-slate-700 text-slate-300 hover:bg-slate-800/50 text-lg px-8 py-3 bg-transparent"
              >
                Learn More
              </Button>
            </div>
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-100">Powerful Features for Every Role</h2>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
            <CardContent className="p-12 text-center">
              ...
              <Button
                size="lg"
                onClick={onGetStarted}
                className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-lg px-12 py-4"
              >
        ...
        {/* Footer */}
        <footer className="container mx-auto px-4 py-8 border-t border-slate-700/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
...
function FeatureCard({
  ...
  return (
    <Card className={`bg-gradient-to-br ${color} p-0.5 group hover:scale-105 transition-transform duration-300`}>
      <div className="bg-slate-900/90 rounded-lg p-6 h-full">
        <Icon className="h-12 w-12 text-slate-300 mb-4 group-hover:scale-110 transition-transform duration-300" />
