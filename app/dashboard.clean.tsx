...
export default function Dashboard({ userRole, user, onLogout }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      {/* Main content area */}
      <main className="p-6">
        {activeTab === "dashboard" && <DashboardContent userRole={userRole} user={user} userId={getUserId()} />}
...
function DashboardContent({ userRole, user, userId }: { userRole: string; user: { name: string; username: string }; userId?: string }) {
  return (
    <div className="space-y-6">
      ...
      <SalesDashboard userRole={userRole} userId={userId} />
